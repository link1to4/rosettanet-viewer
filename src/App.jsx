...
import { ChevronRight, ChevronDown, Search, X, Layers, Maximize2, Minimize2, Upload, FileText, AlertCircle, CheckCircle2 } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto pt-10">
          <div className="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
            <div className="bg-slate-800 p-6 text-white text-center">
              <h1 className="text-2xl font-bold tracking-tight">RosettaNet Spec Viewer</h1>
